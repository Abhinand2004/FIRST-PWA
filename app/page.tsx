export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-pink-950 via-rose-900 to-black text-white overflow-hidden">
      ...
      {/* HERO */}
<section className="relative h-screen w-screen flex flex-col items-center justify-center px-2 overflow-hidden">
  ...
  <div className="mx-auto w-full max-w-7xl h-full flex flex-col justify-between py-8 md:py-12">
    ...
    <div className="text-center shrink-0 mb-4 md:mb-8">
      <h1 className="text-5xl md:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-pink-200 via-rose-200 to-white bg-clip-text text-transparent mb-2">
        Hii 👋
      </h1>
